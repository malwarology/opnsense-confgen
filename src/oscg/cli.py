...
def _generate_configs(ini_path, debug=False):
    """Run the core configuration generator and return OPNsense and WireGuard client configs."""
    ...
    return gc.os_config, gc.wg_config
...
def main():
    ...
    os_config, wg_config = _generate_configs(_get_path(args.ini), debug=args.debug)
